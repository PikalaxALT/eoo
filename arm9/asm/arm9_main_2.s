...
_0231137C:
	...
	bne _02311398
	cmp r0, #1
	ldreq r5, _02311484 ; =0x0231426C
	beq _023113A8
_02311398:
	cmp r1, #3
	bne _023113A8
	cmp r0, #1
	ldreq r5, _02311488 ; =0x02314260
_023113A8:
	mov r7, #1
	mov r6, r7
	mov r1, #0x20
...
_02311480: .word 0x02314254
_02311484: .word 0x0231426C
_02311488: .word 0x02314260
...
_023138D8:
	mov r1, r0, lsr r2
	ands r0, r1, #0xf0
	ldreq r0, _02313908 ; =0x02314278
	ldreqsb r0, [r0, r1]
	addeq r0, r0, r2
	bxeq lr
	ldr r0, _02313908 ; =0x02314278
	mov r1, r1, lsr #4
	ldrsb r0, [r0, r1]
	add r0, r0, r2
	add r0, r0, #4
